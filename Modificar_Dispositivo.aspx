<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Modificar_Dispositivo.aspx.vb" Inherits="Menu2.Modificar_Dispositivo" %>
...
<head>
    ...
    <title>Modificar Dispositivo Informatico</title>
    <!-- Bootstrap Core CSS -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <br />
                                        ...
                                        <div class="form-group">
                                            <label for="disabledSelect">ID Informatica</label>
                                            <input class="form-control"  type="text"  disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="disabledSelect">Numero Serie</label>
                                            <input class="form-control"  type="text"  disabled>
                                        </div>
