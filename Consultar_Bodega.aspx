<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Consultar_Bodega.aspx.vb" Inherits="Menu2.Consultar_Bodega" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Consultar Dispositivo en Bodega</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TxtNombreBodega" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="33px" Width="184px"></asp:TextBox>&nbsp;</td>
                            <td colspan="2" class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="BtnBuscarBodega" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Buscar" Width="82px" />&nbsp;</td>
                        </tr>
                        <tr>
                                <td colspan="3">
                                    <br />
