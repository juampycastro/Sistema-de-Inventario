<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Consultar_Dispositivo.aspx.vb" Inherits="Menu2.Consultar_Dispositivo" %>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="WebForm1.html">Inchalam</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar Dispositivo Informatico</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        ...
                        <table>
                        <tr>
                            <td class="auto-style3"><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#003399" Text="Tipo Dispositivo"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                            <td class="auto-style1"><asp:TextBox ID="TxtNombreDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="33px" Width="184px"></asp:TextBox></td>
                            <td colspan="2" class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="BtnBuscarDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Buscar" Width="82px" />&nbsp;</td>
                        </tr>
                        <tr>
                                <td colspan="3">
                                    <br />
                                    ...
                                    <br />
                                    <asp:GridView ID="grilla" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Ridge" BorderWidth="1px" CellPadding="3" CellSpacing="3">
