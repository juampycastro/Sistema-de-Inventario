<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Eliminar_Bodega.aspx.vb" Inherits="Menu2.Eliminar_Bodega" %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="auto-style6">
                    <h2 class="page-header">Eliminar Dispositivo de Bodega</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="auto-style4">
                                <div class="auto-style2">
                                    <form id="form2" runat="server">
                                        <table>
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#003399" Text="Tipo Dispositivo"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                                                <td class="auto-style1"><asp:TextBox ID="TxtDispositivoBodega" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="33px" Width="184px"></asp:TextBox></td>
                                                <td colspan="2" class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="BtnBuscarDispositivoBodega" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Buscar" Width="82px" />&nbsp;</td>
                                            </tr>
                                            <tr>
                                                  <td colspan="3">
                                                      <br />
                                                      Dispositivos en Bodega Encontrados: <br />
                                                      <br />
                                                      &nbsp;<asp:DropDownList ID="CmbDispositivoBodega" runat="server" Height="35px" Width="253px"></asp:DropDownList>
                                                      <br />
                                                      <br />
                                            </tr>
                                            <tr>
                                                <td colspan="3" align="center"><asp:Button ID="BtnEliminarBodegaDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Eliminar" Width="82px" /></td>
                                            </tr>
                                        </table>                                        
                                    </form>
