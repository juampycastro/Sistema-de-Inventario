<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Consultar_ServicioTecnico.aspx.vb" Inherits="Menu2.Consultar_ServicioTecnico" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Consultar Servicio Tecnico</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        ...
                        <table>
                        <tr>
                            <td><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#003399" Text="Numero Orden"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                            <td class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TxtNombreServicio" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="33px" Width="184px"></asp:TextBox>&nbsp;</td>
                            <td colspan="2" class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="BtnBuscarServicioTecnico" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Buscar" Width="82px" />&nbsp;</td>
                        </tr>
                        <tr>
                                <td colspan="3">
                                    <br />
                                    ...
                                    <br />
                                    <asp:GridView ID="grilla" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="3">
