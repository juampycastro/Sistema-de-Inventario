<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Eliminar_Dispositivo.aspx.vb" Inherits="Menu2.Eliminar_Dispositivo" %>
...
<head>
    ...
    <title>Eliminar Dispositivo Informatico</title>
    <!-- Bootstrap Core CSS -->
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="row">
                <div class="auto-style6">
                    <h2 class="page-header">Eliminar Dispositivo Informatico</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="auto-style3">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Datos Dispositivo Informatico</div>
                            ...
                            <div class="auto-style4">
                                <div class="auto-style2">
                                    <form id="form2" runat="server">
                                        <table>
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#003399" Text="Marca Dispositivo"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                                                <td class="auto-style1"><asp:TextBox ID="TxtNombreDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="33px" Width="155px"></asp:TextBox></td>
                                                <td colspan="2" class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="BtnBuscarDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Buscar" Width="82px" />&nbsp;</td>
                                            </tr>
                                            <tr>
                                                  <td colspan="3">
                                                      <br />
                                                      Dispositivos Encontrados: <br />
                                                      <br />
                                                      &nbsp;<asp:DropDownList ID="CmbDispositivo" runat="server" Height="35px" Width="253px"></asp:DropDownList>
                                                      <br />
                                                      <br />
                                            </tr>
                                            <tr>
                                                <td colspan="3" align="center"><asp:Button ID="BtnEliminarDispositivo" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" Height="29px" Text="Eliminar" Width="82px" /></td>
                                            </tr>
                                        </table>                                        
                                    </form>
