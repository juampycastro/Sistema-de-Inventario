<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Modificar_Trabajador.aspx.vb" Inherits="Menu2.Modificar_Trabajador" %>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="page-header">Modificar Trabajador</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
